...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  var urlOpts = {
        ...
        pathname: '/v1/users/self',
        query: {
          access_token: accessToken
        }
      };

  urlOpts.query.sig = signature.generate(urlOpts.pathname, urlOpts.query, this._oauth2._clientSecret);

  this._oauth2.get(url.format(urlOpts), accessToken, function (err, body, res) {
